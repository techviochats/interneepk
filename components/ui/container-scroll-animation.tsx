...
export const ContainerScroll = ({
  ...
  return (
    <>
      <div
        className="h-[58rem] mt-20 flex items-center justify-center relative p-20 "
        ref={containerRef}
      >
        <div
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="bg-gray-100 h-full w-full rounded-2xl grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 overflow-x-hidden overflow-y-auto p-4 scroll ">
